...
public abstract class AbstractPLSQLParser extends Parser {
	/**
	 ...
	 */
	protected AbstractPLSQLParser(TokenStream input) {
		super(input);
	}
	 ...
	 */
	protected AbstractPLSQLParser(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
