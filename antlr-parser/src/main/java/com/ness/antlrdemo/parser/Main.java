...
import java.io.*;
import com.ness.antlrdemo.parser.TParser.a_return;
     ...
     */
    	...
    	public static void main(String[] args)
        {
            try
            {
                ...
                {
                    System.err.println("Usage: java -jar antlr-parser-1.0-SNAPSHOT-jar-with-dependencies.jar <directory | filename.dmo>");
                }
            }
            catch (Exception ex)
            {
